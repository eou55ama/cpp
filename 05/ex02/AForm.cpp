...
AForm::AForm() :name("Default"),required_grade(90),required_execute(90),signe(0)
{
}

AForm::AForm(const std::string Name,const int r_g,const int r_e) :name(Name),required_grade(r_g),required_execute(r_e),signe(0)
{
}

AForm::AForm(const AForm& copy):name(copy.getName()),required_grade(copy.getRequierdGrade()),required_execute(copy.getRequierdExecute()),signe(0)
{
    *this = copy;
}
